...
- The ONLY address that currently accepts mail is the **Resend account owner**, `as300102@gmail.com` (Resend's test rule). A send from `onboarding@resend.dev` to that address returns 200.
