...
- [Email delivery via Resend](email-resend.md) — all email goes via Resend HTTP API (nodemailer removed); "no email arrives" = unverified Resend domain, not a code bug.
